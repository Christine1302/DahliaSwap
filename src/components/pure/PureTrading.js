                    ...
                    <div className='d-flex flex-row mb-2'>
                        <div className='mt-3 main-view'>
                            ...
                            <Card className='mt-2 it-trading_view'>
                                <CardBody style={{ fontSize: '20px', fontWeight: 'bold' }}>
                                Welcome to Dahlia Swap! Please choose an option to the left to begin.
                                </CardBody>
                            </Card>
                        </div>
                            ...
                            {/* <Card> */}
                                {/* <CardBody> */}
                                    {/* <div className='text-center wallet-count-block'> */}
                                        {/* <img src={theme.nav_inventory} className='it-icon non_op'/> */}
