...
class AddDahlia extends Component {
    ...
    render() {
        ...
        return (
            <div className={`it-container ${theme.night_class}`}>
                <div className='it-add-dahlia pb-4'>
                    <Row className='justify-content-between mx-4'>
                        <Col className='mt-3'>
                            <p className='it_page_title'>Add dahlia</p>
                        </Col>
                        <Col className='mt-3'>
                        ...
                        <Col className='mt-3'>
                            <div className='it_cycle_times' onClick={() => push(URLS.Inventory)}>
                                <img src={theme['close']} />
                            </div>
                        </Col>
                    </Row>
                    <Row className='dahlia-cards'>
                        {
                            counts.map((item, i) => (
...
export default connect(mapStateToProps, mapDispatchToProps)(AddDahlia);