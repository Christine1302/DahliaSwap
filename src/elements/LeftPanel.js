...
class LeftPanel extends Component{
    ...
    render() {
        ...
        const {
            my_orders_badge = 3, push, inventory_active, sellers_active,
        ...
        return (
            <div>
                ...
                <div className='it-left-panel-nav'>
                    ...
                    {
                        [
                            [inventory_active, URLS.Inventory, require('../assets/icons/nav_wallet.svg'), 'Inventory'],
                            // [analytics_active, URLS.Analytics, require('../assets/icons/analytics.svg'), 'Analytics'],
                            [sellers_active, URLS.Sellers, require('../assets/icons/traders.svg'), 'Sellers'],
