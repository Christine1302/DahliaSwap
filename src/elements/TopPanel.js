...
class TopPanel extends Component {
    ...
    render() {
        ...
        const {
            ...
            account, switchSignUPModal, switchSignINModal,
            baseWrapper
        } = this.props;
                        ...
                        <div className='d-flex flex-row-reverse mr-2'>
                            {
                                account ? [
                                    ...
                                    <div className='no-account'>
                                        <strong className='it-fs14 signin' onClick={() => switchSignINModal(true)}>
                                            Sign In
                                        </strong>
                                        <Button className='bnt-light signup' color="link" onClick={() => switchSignUPModal(true)}>
                                            Sign Up
                                        </Button>
                                    </div>
                                )
