                ...
                <div className='px-3 row-sections'>
                    <div className="d-flex justify-content-center mt-3">
                        <div className="d-flex flex-row it-btn-group w-100">
                            <div className="it-btn active w-50">Requests</div>
                            <div className="it-btn border-left-0 w-50"><span>Finished</span></div>
                        </div>
                    </div>
                    <Row className='mt-3 text-left'>
                        <Col md={3}>
                            <div className="d-flex flex-column">
                                ...
                                <div className='it-fs11 it_light_opacity'>11/11/2023</div>
                            </div>
                        </Col>
                        <Col md={6}>
                            <div className="d-flex flex-column pl-4">
                                <div className='it-fs14 it-fw6'>Ace Summer Sunset</div>
                                <div className='it-fs11 it_light_opacity'>Babylon Red</div>
                            </div>
                        </Col>
                        <Col md={3}>
                            <div className="d-flex flex-column">
                                <span className='it-fs14 text-success it-fw6'></span>
                            </div>
                        </Col>
                    </Row>
                    ...
                    <Row className='mt-3 text-left'>
                        <Col md={3}>
                            <div className="d-flex flex-column">
                                <div className='it-fs14'>09:36</div>
                                <div className='it-fs11 it_light_opacity'>11/12/2023</div>
                            </div>
                        </Col>
                        <Col md={6}>
                            <div className="d-flex flex-column pl-4">
                                <div className='it-fs14 it-fw6'>Cafe au Lait</div>
                                <div className='it-fs11 it_light_opacity'>Crichton Honey</div>
                            </div>
                        </Col>
                        <Col md={3}>
                            <div className="d-flex flex-column">
